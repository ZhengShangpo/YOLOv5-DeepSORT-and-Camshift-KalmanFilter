...
class KalmanFilter(object):
    ...
    def __init__(self):
        ...
        # Motion and observation uncertainty are chosen relative to the currin
        # the model. This is a bit hacky.ent
        #         # state estimate. These weights control the amount of uncertainty
